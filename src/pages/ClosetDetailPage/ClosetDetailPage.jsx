...
const ClosetDetailPage = () => {
    ...
    const categoryLabel = useMemo(() => {
        ...
        const sub = main?.subcategories?.find(
            (subcategory) => subcategory.id === item.subCategory
        );
    ...
    const renderField = (label, fieldName, options = {}) => {
        ...
        const displayValue = options.formatDisplay
            ? options.formatDisplay(value)
            : value || "-";
        const inputType = options.inputType ?? "text";

        const rowClass = clsx(
            styles.fieldRow,
            options.alignTop && styles.fieldAlignTop
        );
        ...
        if (!isEditing) {
            return (
                <div className={rowClass}>
                    ...
                    <span
                        className={clsx(styles.fieldValue, options.valueClass)}
                    >
                        {displayValue}
                    </span>
                </div>
