    ...
    <div className={styles.container}>
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.fieldGroup}>
          ...
          {messages.email && (
            <div
              className={`${styles.validationMessage} ${validation.email ? styles.success : styles.error}`}
            >
              {messages.email}
            </div>
          )}
        ...
        <div className={styles.fieldGroup}>
          ...
          {messages.verification && (
            <div
              className={`${styles.validationMessage} ${validation.emailVerified ? styles.success : styles.error}`}
            >
              {messages.verification}
            </div>
          )}
        ...
        <div className={styles.fieldGroup}>
          ...
          {messages.nickname && (
            <div
              className={`${styles.validationMessage} ${validation.nickname ? styles.success : styles.error}`}
            >
              {messages.nickname}
            </div>
          )}
        ...
        <div className={styles.fieldGroup}>
          ...
          {messages.password && (
            <div
              className={`${styles.validationMessage} ${validation.password ? styles.success : styles.error}`}
            >
              {messages.password}
            </div>
          )}
        ...
        <div className={styles.fieldGroup}>
          ...
          {messages.passwordConfirm && (
            <div
              className={`${styles.validationMessage} ${validation.passwordConfirm ? styles.success : styles.error}`}
            >
              {messages.passwordConfirm}
            </div>
          )}
